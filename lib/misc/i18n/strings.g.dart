...
/// Strings: 8
///
/// Built on 2024-01-08 at 11:29 UTC
...
// Path: <root>
typedef StringsJa = Translations; // ignore: unused_element
...
class Translations implements BaseTranslations<AppLocale, Translations> {
  ...
  // Translations
  String get appName => 'エクステレモ';
  String get retry => 'リトライ';
  String get networkError => 'ネットワークエラーが発生しました';
  String get emptyError => 'データが取得できませんでした';
  String height({required Object height}) => '高さ: ${height}';
  String weight({required Object weight}) => '重さ: ${weight}';
  String get favorite => 'お気に入り';
  String get index => 'インデックス';
}
...
extension on Translations {
  dynamic _flatMapFunction(String path) {
    switch (path) {
      ...
      case 'height':
        return ({required Object height}) => '高さ: ${height}';
      case 'weight':
        return ({required Object weight}) => '重さ: ${weight}';
      case 'favorite':
        return 'お気に入り';
      case 'index':
        return 'インデックス';
